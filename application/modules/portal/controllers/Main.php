...
class Main extends CI_Controller {
	...
	public function dashboard()
	{
		...
		$query = "SELECT t1.title,t1.description,t2.file_name as cover_image,t1.content_type FROM blogs as t1 LEFT JOIN media as t2 ON t2.id = t1.cover_image ORDER BY t1.date_created DESC LIMIT 4";
		...
		$module["blogs_count"] = $this->db->order_by("id","desc")->get("blogs")->num_rows();
	...
	public function invitations()
    {
		...
		$module["menu"] = $this->user_access;
		$this->load->view('main/template/header',$module);
		$this->load->view('main/invitations_view',$module);
		$this->load->view('main/template/footer');
	}
	
	public function icd_tickets()
    {
		if (!in_array($this->router->fetch_method(), $this->user_access)) 
		{
			redirect(base_url()."portal/main/".$this->default_page);
		...
		$module["menu"] = $this->user_access;
		$this->load->view('main/template/header',$module);
		$this->load->view('main/icd_tickets_view',$module);
		$this->load->view('main/template/footer');
	}
	...
	public function blogs()
    {
		...
		$module["menu"] = $this->user_access;
		$this->load->view('main/template/header',$module);
		$this->load->view('main/blogs_view',$module);
		$this->load->view('main/template/footer');
	}
	...
	public function welcome()
    {
		...
		$module["menu"] = $this->user_access;
		$this->load->view('main/template/header',$module);
		$this->load->view('main/welcome_view',$module);
		$this->load->view('main/template/footer');
	}
	public function itouch_logs()
    {
		$module["module_name"] = $this->router->fetch_method();
		$module["menu"] = $this->user_access;
		$this->load->view('main/template/header',$module);
		$this->load->view('main/itouch_logs_view',$module);
		$this->load->view('main/template/footer');
	}
	
	public function itouch_users()
    {
		$module["module_name"] = $this->router->fetch_method();
		$module["menu"] = $this->user_access;
		$this->load->view('main/template/header',$module);
		$this->load->view('main/itouch_users_view',$module);
		$this->load->view('main/template/footer');
	}
	
	public function itouch_dashboard()
    {
		$module["module_name"] = $this->router->fetch_method();
		$module["menu"] = $this->user_access;
		$module["site_login"] = $this->db->query("select count(*) as counts from gbts.access_log")->row()->counts;
		$module["month_login"] = $this->db->query("select count(*) as counts from gbts.access_log WHERE month(sdate) = '".date("m")."' AND year(sdate) = '".date("Y")."'")->row()->counts;
		$module["ticket_search"] = $this->db->query("select count(*) as counts from gbts.searches")->row()->counts;
		$module["ticket_month"] = $this->db->query("select count(*) as counts from gbts.searches  WHERE month(sdate) = '".date("m")."' AND year(sdate) = '".date("Y")."'")->row()->counts;
		$module["tickets"] = $this->db->query("select * from gbts.searches ORDER BY id DESC LIMIT 5")->result();
		$module["users"] = $this->db->query("select fname as first_name,lname as last_name,sdate as date_created from gbts.customer ORDER BY id DESC LIMIT 5")->result();
		$this->load->view('main/template/header',$module);
		$this->load->view('main/itouch_dashboard_view',$module);
		$this->load->view('main/template/footer');
	}
	
	public function gbu_dashboard()
    {
		$module["module_name"] = $this->router->fetch_method();
		$module["menu"] = $this->user_access;
		$module["site_login"] = $this->db->query("select count(*) as counts from gbts.access_log")->row()->counts;
		...
		$module["users"] = $this->db->query("select fname as first_name,lname as last_name,sdate as date_created from gbts.customer ORDER BY id DESC LIMIT 5")->result();
		$this->load->view('main/template/header',$module);
		$this->load->view('main/gbu_dashboard_view',$module);
		$this->load->view('main/template/footer');
	}
	
	public function itouch_search_logs()
    {
		$module["module_name"] = $this->router->fetch_method();
		$module["menu"] = $this->user_access;
		$this->load->view('main/template/header',$module);
		$this->load->view('main/itouch_search_logs_view',$module);
		$this->load->view('main/template/footer');
	}
	...
	public function charities()
    {
		...
		$module["menu"] = $this->user_access;
		$this->load->view('main/template/header',$module);
		$this->load->view('main/charities_view',$module);
		$this->load->view('main/template/footer');
	}
	...
	public function privacy_policy()
    {
		...
		$module["menu"] = $this->user_access;
		$module["dynamic_settings"] = $this->db->get("dynamic_settings")->row();
		$this->load->view('main/template/header',$module);
		$this->load->view('main/dynamic_view',$module);
		$this->load->view('main/template/footer');
	}
	...
	public function faqs()
    {
		...
		$module["dynamic_settings"] = $this->db->get("dynamic_settings")->row();
		$this->load->view('main/template/header',$module);
		$this->load->view('main/faq_view',$module);
		$this->load->view('main/template/footer');
	}
	...
	public function about_us()
    {
		...
		$module["dynamic_settings"] = $this->db->get("dynamic_settings")->row();
		$this->load->view('main/template/header',$module);
		$this->load->view('main/about_us_view',$module);
		$this->load->view('main/template/footer');
	}
	 ...
	 public function face_recognition()
    {
		...
		$module["roles"] = $this->db->get("roles")->result();
		$this->load->view('main/template/header',$module);
		$this->load->view('main/face_recognition_view',$module);
		$this->load->view('main/template/footer');
	}
}
