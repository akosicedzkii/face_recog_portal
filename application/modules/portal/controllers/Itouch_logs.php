...
class Itouch_logs extends CI_Controller {
    ...
    public function get_itouch_logs_list()
    {
        $this->load->model("portal/data_table_model","dt_model");  
        $this->dt_model->select_columns = array("t1.id","t1.sdate","t1.username");  
        $this->dt_model->where  = array("t1.id","t1.sdate","t1.username");  
        $select_columns = array("id","sdate","username");  
        $this->dt_model->table = "gbts.access_log as t1";  
    ...
    public function download()
    {
        ...
        // file name 
        $filename = 'itouch_logs_'.date('YmdHis').'.csv'; 
