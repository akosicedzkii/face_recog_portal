  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        ?>
		<?php 
          if (in_array("welcome", $menu)) {
             ?>
              <li <?php if($module_name == "welcome"){echo 'class="active"';}?>><a href="<?php echo base_url()."portal/main/welcome"?>"><i class="fa fa-list-alt"></i><span>Welcome</span></a></li>
             <?php
          } 
        ?>
		
		<?php 
          if (in_array("gbu_dashboard", $menu)) {
             ?>
              <li <?php if($module_name == "gbu_dashboard"){echo 'class="active"';}?>><a href="<?php echo base_url()."portal/main/gbu_dashboard"?>"><i class="fa fa-dashboard"></i><span>GBU Dashboard</span></a></li>
             <?php
          } 
        ?>
		<?php 
          if (in_array("itouch_dashboard", $menu)) {
             ?>
              <li <?php if($module_name == "itouch_dashboard"){echo 'class="active"';}?>><a href="<?php echo base_url()."portal/main/itouch_dashboard"?>"><i class="fa fa-dashboard"></i><span>iTOUCH Dashboard</span></a></li>
             <?php
          } 
        ?>
		<?php 
          if (in_array("itouch_users", $menu)) {
             ?>
              <li <?php if($module_name == "itouch_users"){echo 'class="active"';}?>><a href="<?php echo base_url()."portal/main/itouch_users"?>"><i class="fa fa-users"></i><span>iTOUCH Users</span></a></li>
             <?php
          } 
        ?>
        <?php 
          if (in_array("icd_tickets", $menu)) {
             ?>
              <li <?php if($module_name == "icd_tickets"){echo 'class="active"';}?>><a href="<?php echo base_url()."portal/main/icd_tickets"?>"><i class="fa fa-list-alt"></i><span>ICD Tickets</span></a></li>
             <?php
          } 
        ?>
		<?php 
          if (in_array("itouch_logs", $menu)) {
             ?>
              <li <?php if($module_name == "itouch_logs"){echo 'class="active"';}?>><a href="<?php echo base_url()."portal/main/itouch_logs"?>"><i class="fa fa-list-alt"></i><span>iTOUCH Login Logs</span></a></li>
             <?php
          } 
        ?>
		
		<?php 
          if (in_array("itouch_search_logs", $menu)) {
             ?>
              <li <?php if($module_name == "itouch_search_logs"){echo 'class="active"';}?>><a href="<?php echo base_url()."portal/main/itouch_search_logs"?>"><i class="fa fa-list-alt"></i><span>iTOUCH Search Logs</span></a></li>
             <?php
          } 
        ?>
        <?php 
          if (in_array("face_recognition", $menu)) {
             ?>
              <li <?php if($module_name == "face_recognition"){echo 'class="active"';}?>><a href="<?php echo base_url()."portal/main/face_recognition"?>"><i class="fa fa-list-alt"></i><span>Face Recognition</span></a></li>
             <?php
          } 
        ?>
        <?php 
