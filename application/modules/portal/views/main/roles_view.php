                    ...
                    <form class="form-horizontal" id="roleForm" data-toggle="validator">
                        ...
                        <div class="form-group">
                             ...
                             <div class="col-sm-8">
                                    <b>Main Navigation</b>
									 ...
									 <div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="welcome">
                                        Welcome Page
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                    ...
                                    <b>Home</b>
									 ...
									 <div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="icd_tickets">
                                        ICD Tickets
                                        </label>
                                    </div>
									<div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="gbu_dashboard">
                                        GBU Dashboard
                                        </label>
                                    </div>
									<div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="itouch_dashboard">
                                        iTOUCH Dashboard
                                        </label>
                                    </div>
									 <div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="itouch_users">
                                        iTOUCH Users
                                        </label>
                                    </div>
									 <div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="itouch_logs">
                                        iTOUCH Login Logs
                                        </label>
                                    </div>
									 ...
									 <div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="itouch_search_logs">
                                        iTOUCH Search Logs
                                        </label>
                                    </div>
                                     ...
                                     <div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="face_recognition">
                                        Face Recognition
                                        </label>
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="invitations">
                                        Invitations
                                        </label>
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="rsvp">
                                        RSVP
                                        </label>
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="blogs">
                                        Blogs
                                        </label>
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="about_us">
                                        About Us
                                        </label>
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="charities">
                                        Charities
                                        </label>
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        <label>
                                        <input type="checkbox" id="modules" value="faqs">
                                        FAQs
                                        </label>
                                    </div>-->
                        ...
                        <div class="form-group">
                            ...
                            <select id="inputDefaultPage">
                                ...
                                <option value="icd_tickets">ICD Tickets</option>
                                <option value="gbu_dashboard">GBU Dashboard</option>
                                <option value="itouch_dashboard">iTOUCH Dashboard</option>
                                <option value="itouch_logs">iTOUCH Login Logs</option>
                                <option value="itouch_users">iTOUCH Users</option>
                                <option value="itouch_search_logs">iTOUCH Search Logs</option>
