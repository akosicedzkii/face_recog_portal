...
<section class="content-header">
    <h1>
    <?php 
	$module_name = "iTOUCH Search Logs";
...
<div class="box" id="main-list">
    ...
    <!-- /.box-header -->
    <div class="box-body">
        <table id="itouch_search_logsList" class="table table-bordered table-striped">
        <thead>
        <tr>
            <th>ID</th>
            <th>Login Date</th>
...
<!-- /.modal -->
<div class="modal fade" id="itouch_search_logsDetailsModal">
...
<script>
    ...
    var table = $('#itouch_search_logsList').DataTable({ 
        "order": [[ 0, "desc" ]] ,
        'autoWidth'   : true,
        "processing" : true,
        "serverSide" : true, 
        "ajax" : "<?php echo base_url()."portal/itouch_search_logs/get_itouch_search_logs_list";?>",
    ...
    var main = function(){
        ...
        $("#deleteLogs").click(function(){
            ...
            $.ajax({
                url: "<?php echo base_url();?>portal/itouch_search_logs/delete_all_itouch_search_logs",
                type: "post",
                data: values ,
                success: function (response) {
                    toastr.success("All itouch_search_logs successfully deleted");
        ...
        $("#downloadBtn").click(function(){
            window.open ("<?php echo base_url()."portal/itouch_search_logs/download?fromDate="?>" + startDateDownload + "&toDate=" + endDateDownload,"_blank") ;
        });
    }
    ...
    function _view(id)
    {
        var values = { "id": id };
        $.ajax({
            url: "<?php echo base_url();?>portal/itouch_search_logs/get_log_details",
            type: "post",
            data: values ,
            success: function (response) {
                ...
                $("#itouch_search_logsDetailsModal").modal("show");
            },
            error: function(jqXHR, textStatus, errorThrown) {
            console.log(textStatus, errorThrown);
            $("#deleteLogs").button("reset");
