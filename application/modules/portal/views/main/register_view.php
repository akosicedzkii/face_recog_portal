...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <div class="form-group has-feedback">
	  ...
	  <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Branch Store" id="branch_store" required>
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="row">
      <div class="col-xs-4">
...
<script>
    ...
    {   
        $("#formRegister").submit(function(e){
            ...
            var values = { "branch_store":branch_store,"username" : username , "password" : password , "firstname" : firstname , "middlename": middlename, "lastname":lastname,"email" : email };
            $.ajax({
